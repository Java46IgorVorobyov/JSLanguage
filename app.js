...
//adding element/s at and of an array 
...
console.log(ar);
const ar1 = [-8, 30, -57];
// ar.push(ar1); //there will be added array but not separated number 
...
// everything has been said about "push" will work for "unshift" omly unlike "push" unshift method 
...
// third argument designates sequence of being inserted elements like push/unshift
...
// el - -57; -57 will be remove from array ar
...
//четные в порядке возрастания не четные в порядке убывания 
//expected [-10, 4, 28, 40, 27, 25, 17, 15, 13];
//task: write a comparator (a comporator returns < 0 if first less than second, > 0
